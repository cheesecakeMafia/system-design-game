...
│   ├── START-HERE.md             # Course home page (module map, status tracking)
│   ├── curriculum.md             # Detailed curriculum plan (v2)
...
**NOTE**: Course files live in `course/`. The root README.md is the public-facing hero README. The course entry point is `course/START-HERE.md`.
